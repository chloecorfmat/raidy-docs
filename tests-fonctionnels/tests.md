...
* [Profil](tests-fonctionnels/API/profile.md)
* [Sport](tests-fonctionnels/API/sporttypes.md)

### Helper
* [Raids](tests-fonctionnels/API/Helper/raids.md)
	* [Parcours](tests-fonctionnels/API/Helper/tracks.md)

### Organizer
* [Raids](tests-fonctionnels/API/Organizer/raids.md)
	* [Parcours](tests-fonctionnels/API/Organizer/tracks.md)
	* [Points d'intérêt](tests-fonctionnels/API/Organizer/pois.md)
	* [Type de points d'intérêt](tests-fonctionnels/API/Organizer/poitypes.md)
